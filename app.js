...
let categories = menu.map(food => food.category)
categories = ["All", ...new Set(categories)]

categories.forEach(category => {
  let categoryButton = document.createElement("button")
  categoryButton.innerText = category
  categoryButton.className="btn-item"
...
function showItems(filteredCategory){
  menuItemsContainer.innerHTML = ""
  let filteredMenu = menu.filter(item => filteredCategory.includes(item.category) ? true : false)
